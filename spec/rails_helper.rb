...
require_relative 'support/helper/controller_spec_helper'
require_relative 'support/factory_bot'
require_relative 'support/database_cleaner'
require_relative 'support/helper/app_spec_helper'
...
RSpec.configure do |config|
  ...
  config.extend Helper::ControllerSpec, type: :controller
